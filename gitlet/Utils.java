...
/** Assorted utilities.
 *  @author P. N. Hilfinger & Lily Vittayarukskul
 */
class Utils {
    ...
    /** Returns true iff the DIRECTORY contains FILENAME. */
    static boolean dirContains(String directory, String fileName) {
    ...
    /** Returns FILENAME from DIRECTORY iff the DIRECTORY contains FILENAME. */
    ...
    /** Removes the file FILENAME from the given DIRECTORY. */
    public static void removeFile(String fileName, String directory) {
